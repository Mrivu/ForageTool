                ...
                try:
                    ...
                    for plant in data:
                        if "count" not in plant or "plantName" not in plant:
                            return render_template("forage.html", areas=areas, regions=regions, message = "Invalid manual import file. See the github for help.")
                        if not commands.get_plant(plant["plantName"]):
                            return render_template("forage.html", areas=areas, regions=regions, message = "Invalid plant in import. See the github for help.")
